...
public class Report {
	...
	public Report(String string) {
		ReportFactoryProducer Factor = new ReportFactoryProducer(string);
		this.setFooter(Factor.getFactory().reportCreatorFooter());
		this.setHeader(Factor.getFactory().reportCreatorHeader());
		this.setBody(Factor.getFactory().reportCreatorBody());
	}
